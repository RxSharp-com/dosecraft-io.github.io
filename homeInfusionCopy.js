...
(function () {
  ...
  window.DOSECRAFT_HOME_COPY = {
    ...
    wizard: {
      ...
      saveHint: "You can update medications and schedules anytime from Edit setup. Line care is in treatment settings; reminders are on the Reminders screen.",
      saveButton: "Save and continue",
      additionalSettingsTitle: "Treatment settings",
      treatmentDurationTitle: "Treatment duration",
      treatmentDurationHint: "This helps your Companion show progress and export calendar reminders.",
      durationModeEndDate: "I know my end date",
      durationModeLength: "I know the length of therapy",
      durationModeUnsure: "I'm not sure yet",
      durationEndDateLabel: "Planned end date",
      durationLengthLabel: "Length of therapy",
      durationLengthDays: "Days",
      durationLengthWeeks: "Weeks",
      durationLengthError: "Enter a number greater than zero.",
      durationUnsureHint: "You can still use Dosecraft. Calendar dose reminders need an end date before export.",
    },

    dashboard: {
      nextWeeklyVisit: "Next weekly visit",
      visitHelperText: "Your weekly visit may include labs, dressing change, and line check, depending on your care plan.",
      noVisitScheduled: "No visit scheduled yet.",
      addVisitDate: "Add visit date",
      quickActions: "Quick actions",
      startDoseSession: "Start dose session",
      ...
      playGame: "Play game",
      playMedicationGame: "Play a medication game",
      callCareTeamFallback: "Call your care team using the phone number they provided.",
    },
    ...
    gearMenu: {
      ...
      resetCompanion: "Reset Companion setup",
      clearData: "Clear Dosecraft data",
      addToHomeScreen: "Add to Home Screen",
      confirmResetCompanion: "This will clear your saved Companion treatment setup on this device. It will not contact your clinic or change your treatment.",
      confirmClearData: "This clears Dosecraft data saved on this device. It will not contact your clinic or change your treatment.",
      cancel: "Cancel",
    },

    remindersScreen: {
      title: "Reminders",
      intro: "Dose reminders, calendar export, and visit summary.",
      nextVisitPrefix: "Next visit:",
      editVisitLink: "Edit visit",
      treatmentSettingsLink: "Treatment settings",
    },
    ...
    calendarReminders: {
      ...
      missingVisitDate: "Add your next visit date on the visit screen to enable calendar export.",
      missingVisitTime: "Add your visit time on the visit screen to enable calendar export.",
